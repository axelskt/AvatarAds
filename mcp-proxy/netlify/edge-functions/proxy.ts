...
const FALLBACK: Record<string, unknown> = {
  ...
  tools: [
    ...
    { name: 'clean_audio', description: "Nettoie la voix d'un audio (bruit de fond, souffle, clics). 1 cr/min.", inputSchema: { type: 'object', required: ['audio_url'], properties: { audio_url: { type: 'string' }, confirm: V.confirm } } },
