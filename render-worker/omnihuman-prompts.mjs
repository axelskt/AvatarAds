// GÉNÉRÉ par tools/gen-omnihuman-prompts.mjs depuis shared/omnihuman-prompts.json — ne pas éditer à la main (render-worker).
...
export const OMNIHUMAN_PROMPTS = Object.freeze({
...
export function omnihumanPrompt(o) {
  o = o || {};
...
export function clampOmnihumanPrompt(s) {
