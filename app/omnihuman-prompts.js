// GÉNÉRÉ par tools/gen-omnihuman-prompts.mjs depuis shared/omnihuman-prompts.json — ne pas éditer à la main (app).
...
(function(){
const OMNIHUMAN_PROMPT_MAX = 300;
const OMNIHUMAN_PROMPTS = Object.freeze({
...
window.AA_OMNIHUMAN_MAX = OMNIHUMAN_PROMPT_MAX; window.AA_OMNIHUMAN_VERSION = '2026-09-26a';
})();
