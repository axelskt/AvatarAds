...
//   • suivi : op_name « kieomni:<taskId> » (+ « #cut=… » du correctif « dernier mot ») ; le résultat est rapatrié dans NOTRE
...
import { KIE, kieKey, kieHeaders, kieRecord, kieDownload, kieKindOf } from '../_shared/kie.ts'
...
export const OP_KIE_OMNI = 'kieomni:'
export const KIE_OMNI_STALE_MIN = 60
export const omniKieOn = (): boolean => !!kieKey() && (Deno.env.get('MCP_OMNI_KIE') ?? '1').trim() !== '0'   // MCP_OMNI_KIE=0 : retour à fal sans redéployer
