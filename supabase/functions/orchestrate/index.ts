...
// <<< ANIM-BANK:PROMPT — genere par render-worker/sync-anim-bank.mjs, ne pas editer >>>
    ...
    lineup   — UN PRESENTOIR QUI SE REMPLIT AU FIL DE L'ENUMERATION : une etagere vide, et une offre VISUELLE qui se pose a chaque terme prononce — un colis, une personne qui parle, un cours qui se joue — SANS ecrire les mots (le sous-titre les porte deja). « produit physique, coaching, formation », « tu peux vendre X, Y ou Z », toute liste de 2 a 4 choses qu'on propose. items[k].t = l'instant ou le terme k est prononce (obligatoire pour que chaque carte claque sur son mot).
// <<< /ANIM-BANK:PROMPT >>>
`
...
const ANIM_LEX: [string, string][] = [
  ...
  ['clique', 'screen'], ['clique', 'bio'], ['clique', 'linkbio'], ['clone', 'voice'], ['coachi', 'lineup'],
  ['code', 'qr'], ['colis', 'delivery'], ['colori', 'sizes'], ['comman', 'sales'], ['comman', 'cart'],
  ['comman', 'salesphone'], ['commen', 'comments'], ['commen', 'keyword'], ['commen', 'pin'], ['commen', 'comment'],
  ['commun', 'connect'], ['commun', 'network'], ['compar', 'bars2'], ['compat', 'integrations'],
  ['compet', 'blankfill'], ['compet', 'oneclick'], ['compte', 'post'], ['compte', 'profile'],
  ['compte', 'zoompunch'], ['concur', 'twopaths'], ['connai', 'oneclick'], ['connec', 'connect'],
  ['connec', 'integrations'], ['consta', 'calendar'], ['contac', 'brandeal'], ['contra', 'sign'],
  ['contre', 'stoploss'], ['conver', 'funnel'], ['copie', 'copy'], ['copies', 'copy'], ['cote', 'split'],
  ['cote', 'bars2'], ['couche', 'layers'], ['coup', 'spike'], ['coupe', 'stoploss'], ['courbe', 'weight'],
  ['coute', 'lowcost'], ['coute', 'invoice'], ['couts', 'easydown'], ['crache', 'clipping'], ['croiss', 'grow'],
  ['date', 'deadline'], ['deal', 'sign'], ['debut', 'pnl'], ['debuta', 'easyup'], ['debuta', 'oneclick'],
  ['decoll', 'rocket'], ['decor', 'bgswap'], ['decort', 'explode'], ['defile', 'carousel'], ['degrin', 'easydown'],
  ['demand', 'chat'], ['demand', 'poll'], ['depart', 'lowcost'], ['depass', 'leaderboard'], ['deploi', 'deploy'],
  ...
  ['deux', 'bars2'], ['deux', 'abtest'], ['deux', 'clapper'], ['deuxie', 'retake'], ['devant', 'podium'],
  ['devant', 'leaderboard'], ['devien', 'viral'], ['devien', 'magnet'], ['devis', 'invoice'], ['devis', 'quote'],
  ['differ', 'bars2'], ['differ', 'versus'], ['diffic', 'easyup'], ['dire', 'script'], ['disent', 'review'],
  ['dispo', 'uptime'], ['donne', 'result'], ['donne', 'flow'], ['donne', 'free'], ['dors', 'salesphone'],
  ['dossie', 'folder'], ['droite', 'screen'], ['droite', 'tunnel'], ['dupliq', 'template'], ['eclair', 'lighting'],
  ...
  ['emport', 'tsunami'], ['encais', 'pay'], ['enchai', 'transition'], ['enleve', 'cut'], ['enleve', 'silence'],
  ...
  ['etapes', 'onboarding'], ['etoile', 'star'], ['euros', 'countup'], ['exacte', 'target'], ['experi', 'blankfill'],
  ...
  ['fois', 'template'], ['fond', 'bgswap'], ['fond', 'queue'], ['fond', 'music'], ['format', 'template'],
  ['format', 'crop'], ['format', 'lineup'], ['formul', 'plan'], ['formul', 'form'], ['fort', 'clipping'],
  ['garant', 'badge'], ['garde', 'retakes'], ['gardes', 'gaugefill'], ['genere', 'type'], ['genere', 'render'],
  ['gens', 'network'], ['gens', 'comments'], ['gens', 'preview'], ['glisse', 'dropzone'], ['graphi', 'candles'],
  ['gratui', 'free'], ['grimpe', 'grow'], ['gros', 'iceberg'], ['grossi', 'leads'], ['guider', 'wizard'],
  ['hashta', 'hashtag'], ['hashta', 'caption'], ['haut', 'screen'], ['haut', 'split'], ['haut', 'pin'],
  ['heures', 'daypart'], ['hook', 'hook'], ['image', 'upload'], ['image', 'focus'], ['import', 'upload'],
  ['import', 'dropzone'], ['inclus', 'check'], ['inclus', 'checklist'], ['inscri', 'leads'], ['integr', 'connect'],
  ['integr', 'integrations'], ['integr', 'gaugefill'], ['intern', 'translate'], ['invest', 'lowcost'],
  ['invest', 'roi'], ['jour', 'daypart'], ['jour', 'sales'], ['jours', 'calendar'], ['jours', 'deadline'],
  ['jusqu', 'liquid'], ['kilos', 'weight'], ['laisse', 'render'], ['laisse', 'form'], ['laisse', 'wizard'],
  ['lance', 'rocket'], ['lancem', 'rocket'], ['langue', 'translate'], ['leads', 'leads'], ['leur', 'form'],
  ['leur', 'poll'], ['leurs', 'review'], ['lien', 'copy'], ['lien', 'bio'], ['lien', 'linkbio'], ['lieu', 'compare'],
  ['lieu', 'swap'], ['lieu', 'versus'], ['ligne', 'tunnel'], ['ligne', 'deploy'], ['like', 'share'],
  ['limite', 'deadline'], ['liste', 'leads'], ['livrai', 'delivery'], ['locati', 'property'], ['lumier', 'tunnel'],
  ['lumier', 'lighting'], ['mail', 'form'], ['main', 'onboarding'], ['marche', 'search'], ['marche', 'check'],
  ...
  ['millio', 'views'], ['miniat', 'thumb'], ['minute', 'clock'], ['mise', 'lowcost'], ['mise', 'focus'],
  ['mise', 'deploy'], ['mixage', 'mixer'], ['modele', 'list'], ['modele', 'template'], ['moitie', 'donut'],
  ['moment', 'speedramp'], ['moment', 'trendsound'], ['monde', 'twopaths'], ['monde', 'podium'], ['monde', 'crowd'],
  ['monde', 'map'], ['montag', 'layers'], ['montag', 'timeline'], ['monte', 'easyup'], ['monte', 'trend'],
  ['monte', 'timeline'], ['monte', 'candles'], ['monte', 'thermometer'], ['monten', 'grow'], ['monten', 'views'],
  ['montes', 'upgrade'], ['montre', 'faceless'], ['moteur', 'clapper'], ['mots', 'hashtag'], ['moyen', 'cart'],
  ['musiqu', 'music'], ['nette', 'focus'], ['niveau', 'mixer'], ['niveau', 'thermometer'], ['noir', 'lighting'],
  ['notifi', 'notif'], ['numero', 'podium'], ['occupe', 'automation'], ['offert', 'free'], ['offre', 'plan'],
  ...
  ['pars', 'blankfill'], ['pars', 'template'], ['part', 'rocket'], ['part', 'orbit'], ['part', 'delivery'],
  ['part', 'algorithm'], ['part', 'stoploss'], ['partag', 'viral'], ['partag', 'share'], ['parten', 'brandeal'],
  ['partie', 'iceberg'], ['partou', 'post'], ['partou', 'map'], ['passe', 'phone'], ['passe', 'crop'],
  ['passe', 'pay'], ['passe', 'order'], ['passer', 'leaderboard'], ['passes', 'upgrade'], ['pays', 'map'],
  ['pendan', 'render'], ['pendan', 'queue'], ['pendan', 'salesphone'], ['perd', 'churn'], ['perdu', 'weight'],
  ['perfor', 'pnl'], ['person', 'faceless'], ['person', 'twopaths'], ['person', 'funnel'], ['person', 'crowd'],
  ['perte', 'stoploss'], ['peut', 'salesphone'], ['peux', 'lineup'], ['physiq', 'lineup'], ['piece', 'explode'],
  ['place', 'swap'], ['plan', 'plan'], ['plan', 'upgrade'], ['plan', 'storyboard'], ['planif', 'schedule'],
  ['planni', 'calendar'], ['plat', 'menu'], ['platef', 'logo'], ['plusie', 'sizes'], ['point', 'focus'],
  ['portef', 'portfolio'], ['positi', 'portfolio'], ['positi', 'order'], ['poste', 'calendar'], ['poster', 'post'],
  ['poster', 'preview'], ['postes', 'story'], ['pousse', 'algorithm'], ['premie', 'avatar'], ['premie', 'hook'],
  ['premie', 'leaderboard'], ['premie', 'onboarding'], ['prend', 'booking'], ['prends', 'order'], ['prends', 'cv'],
  ['presqu', 'lowcost'], ['pressi', 'thermometer'], ['presta', 'quote'], ['prevu', 'schedule'], ['prise', 'record'],
  ['prise', 'onboarding'], ['prise', 'clapper'], ['prise', 'retakes'], ['prise', 'retake'], ['prix', 'discount'],
  ['prix', 'menu'], ['prod', 'deploy'], ['produi', 'product'], ['produi', 'lineup'], ['progra', 'schedule'],
  ...
  ['vend', 'salesphone'], ['vendeu', 'orderbook'], ['vendre', 'deadline'], ['vendre', 'lineup'],
