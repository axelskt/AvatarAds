...
const ANIMS = [
  ...
  'lowcost', 'twopaths', 'network', 'rocket', 'funnel', 'bars2', 'idea', 'steps',
  'flow', 'orbit', 'list', 'target', 'search', 'compare', 'swap', 'toggle',
  'check', 'quality', 'podium', 'star', 'speed', 'deadline', 'crowd', 'viral',
  'scrollstop', 'abtest', 'roi', 'free', 'plan', 'layers', 'badge', 'trend',
  'template', 'record', 'dropzone', 'render', 'crop', 'silence', 'chat', 'dashboard',
  'translate', 'bgswap', 'hook', 'export', 'checklist', 'library', 'queue', 'notif',
  'comments', 'timeline', 'results', 'profile', 'invoice', 'settings', 'versus', 'thumb',
  'leaderboard', 'pay', 'sales', 'folder', 'booking', 'form', 'donut', 'map',
  'mixer', 'review', 'upgrade', 'storyboard', 'discount', 'music', 'bio', 'keyword',
  'automation', 'carousel', 'poll', 'story', 'hashtag', 'schedule', 'pin', 'qr',
  'wizard', 'product', 'cart', 'delivery', 'sizes', 'candles', 'portfolio', 'order',
  'pnl', 'mrr', 'churn', 'onboarding', 'integrations', 'property', 'menu', 'weight',
  'quote', 'liquid', 'magnet', 'explode', 'iceberg', 'tunnel', 'thermometer', 'script',
  'clapper', 'retakes', 'transition', 'zoompunch', 'speedramp', 'substyle', 'trendsound', 'algorithm',
  'loop', 'cv', 'framing', 'focus', 'clipping', 'lighting', 'retake', 'caption',
  'preview', 'spike', 'brandeal', 'mediakit', 'inventory', 'stoploss', 'orderbook', 'deploy',
  'uptime', 'leads', 'comment', 'share', 'views', 'linkbio', 'salesphone', 'oneclick',
  'tsunami', 'gaugefill'
]
// <<< /ANIM-BANK:LIST >>>
...
// <<< ANIM-BANK:PROMPT — genere par render-worker/sync-anim-bank.mjs, ne pas editer >>>
    ...
    easyup   — une courbe verte qui monte doucement, sans a-coup : la facilite, « c'est simple », « facile pour un debutant », « sans difficulte ».
...
const ANIM_LEX: [string, string][] = [
  ...
  ['avis', 'review'], ['avis', 'poll'], ['baisse', 'music'], ['barre', 'discount'], ['bascul', 'transition'],
  ['benefi', 'gaugefill'], ['biblio', 'library'], ['blancs', 'cut'], ['blancs', 'silence'], ['bonne', 'retakes'],
  ['bons', 'tools'], ['bons', 'hashtag'], ['bord', 'dashboard'], ['bord', 'liquid'], ['boucle', 'loop'],
  ['bougie', 'candles'], ['bout', 'tunnel'], ['cache', 'iceberg'], ['cadrag', 'framing'], ['cadrer', 'framing'],
  ['calcul', 'render'], ['camera', 'faceless'], ['candid', 'cv'], ['carnet', 'orderbook'], ['carrou', 'carousel'],
  ['carte', 'menu'], ['celui', 'cv'], ['cent', 'funnel'], ['cent', 'donut'], ['cent', 'discount'],
  ['centre', 'orbit'], ['certif', 'badge'], ['change', 'bgswap'], ['change', 'salesphone'], ['charge', 'upload'],
  ['chart', 'candles'], ['chauff', 'thermometer'], ['cherch', 'search'], ['cherch', 'results'],
  ['cherch', 'hashtag'], ['chez', 'logo'], ['chiffr', 'bars2'], ['choisi', 'plan'], ['choisi', 'substyle'],
  ['churn', 'churn'], ['cinqua', 'discount'], ['cles', 'hashtag'], ['clic', 'post'], ['clic', 'toggle'],
  ['clic', 'oneclick'], ['client', 'donut'], ['client', 'map'], ['clique', 'screen'], ['clique', 'bio'],
  ['clique', 'linkbio'], ['clone', 'voice'], ['code', 'qr'], ['colis', 'delivery'], ['colori', 'sizes'],
  ['comman', 'sales'], ['comman', 'cart'], ['comman', 'salesphone'], ['commen', 'comments'], ['commen', 'keyword'],
  ['commen', 'pin'], ['commen', 'comment'], ['commun', 'connect'], ['commun', 'network'], ['compar', 'bars2'],
  ['compat', 'integrations'], ['compet', 'blankfill'], ['compet', 'oneclick'], ['compte', 'post'],
  ['compte', 'profile'], ['compte', 'zoompunch'], ['concur', 'twopaths'], ['connai', 'oneclick'],
  ...
  ['courbe', 'weight'], ['coute', 'lowcost'], ['coute', 'invoice'], ['crache', 'clipping'], ['croiss', 'grow'],
  ['date', 'deadline'], ['deal', 'sign'], ['debut', 'pnl'], ['debuta', 'easyup'], ['debuta', 'oneclick'],
  ['decoll', 'rocket'], ['decor', 'bgswap'], ['decort', 'explode'], ['defile', 'carousel'], ['demand', 'chat'],
  ['demand', 'poll'], ['depart', 'lowcost'], ['depass', 'leaderboard'], ['deploi', 'deploy'], ['depose', 'upload'],
  ['depose', 'dropzone'], ['depuis', 'pnl'], ['dernie', 'tunnel'], ['derush', 'silence'], ['desabo', 'churn'],
  ['descen', 'weight'], ['descri', 'caption'], ['dessus', 'layers'], ['dessus', 'zoompunch'], ['detail', 'explode'],
  ['detail', 'zoompunch'], ['detour', 'bgswap'], ['deux', 'split'], ['deux', 'daypart'], ['deux', 'bars2'],
  ...
  ['differ', 'versus'], ['diffic', 'easyup'], ['dire', 'script'], ['disent', 'review'], ['dispo', 'uptime'],
  ['donne', 'result'], ['donne', 'flow'], ['donne', 'free'], ['dors', 'salesphone'], ['dossie', 'folder'],
  ...
  ['ecrive', 'engage'], ['elite', 'upgrade'], ['empile', 'layers'], ['emport', 'tsunami'], ['encais', 'pay'],
  ...
  ['select', 'screen'], ['semain', 'calendar'], ['semain', 'schedule'], ['seul', 'orbit'], ['seul', 'viral'],
  ['seul', 'automation'], ['seul', 'algorithm'], ['seul', 'oneclick'], ['signen', 'sign'], ['signen', 'quote'],
  ['silenc', 'silence'], ['simple', 'easyup'], ['simple', 'check'], ['site', 'logo'], ['slide', 'carousel'],
  ['sondag', 'poll'], ['sonner', 'notif'], ['sous', 'music'], ['sous', 'substyle'], ['split', 'split'],
  ['spread', 'orderbook'], ['stack', 'tools'], ['stats', 'dashboard'], ['stats', 'mediakit'], ['stock', 'inventory'],
  ['stop', 'stoploss'], ['storie', 'story'], ['story', 'story'], ['struct', 'storyboard'], ['style', 'substyle'],
  ['suffit', 'steps'], ['suis', 'dashboard'], ['suis', 'inventory'], ['suivan', 'phone'], ['superi', 'upgrade'],
  ...
  ['tomben', 'sales'], ['tomben', 'salesphone'], ['tools', 'connect'], ['tourne', 'render'], ['tourne', 'queue'],
  ['tourne', 'automation'], ['tourne', 'clapper'], ['tourne', 'lighting'], ['tourne', 'uptime'],
